...
| [Prospective Strict Official-Account Visuals](./official-account-strict-visual-pipeline.md) | New-run-only native generation, durable final-upload audits, frozen weekly identity, byte-preserving draft export and compatible rollback |
