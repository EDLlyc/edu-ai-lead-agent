...
image_ocr_enabled="$(safe_env_value IMAGE_OCR_ENABLED)"
image_ocr_enabled="${image_ocr_enabled:-false}"
image_ocr_model="$(safe_env_value IMAGE_OCR_MODEL)"
image_ocr_model="${image_ocr_model:-glm-ocr}"
image_ocr_max_input_bytes="$(safe_env_value IMAGE_OCR_MAX_INPUT_BYTES)"
image_ocr_max_input_bytes="${image_ocr_max_input_bytes:-10485760}"
image_ocr_max_response_bytes="$(safe_env_value IMAGE_OCR_MAX_RESPONSE_BYTES)"
image_ocr_max_response_bytes="${image_ocr_max_response_bytes:-1048576}"
image_ocr_timeout_seconds="$(safe_env_value IMAGE_OCR_TIMEOUT_SECONDS)"
...

{
    ...
    printf 'image_ocr_enabled=%s\n' "${image_ocr_enabled}"
    printf 'image_ocr_model=%s\n' "${image_ocr_model}"
    printf 'image_ocr_max_input_bytes=%s\n' "${image_ocr_max_input_bytes}"
    printf 'image_ocr_max_response_bytes=%s\n' "${image_ocr_max_response_bytes}"
    printf 'image_ocr_timeout_seconds=%s\n' "${image_ocr_timeout_seconds}"
