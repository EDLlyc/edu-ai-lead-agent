...
class Settings(BaseSettings):
    ...
    copy_pipeline_version: str = "copy-pipeline-v16-compact-moments"
    ...
    copy_rule_version: str = "moments-rules-v10-compact-warning-recovery"
    copy_preview_policy_version: str = "preview-v10-compact-content-warning-recovery"
